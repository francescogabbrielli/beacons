 ...
 */
public class DataManager implements TransferClient<RemoteData>, TransferServer<Data> {
	 ...
	 */
	public synchronized boolean addData(Data rawData, Location location) {
	 ...
	 */
	@Override
	public synchronized TransferResult<Data> write(Data rawData) throws IOException {
		return addData(rawData, null) 
				? new TransferResult<Data>(TransferResult.RESULT_OK)
				: new TransferResult<Data>(TransferResult.RESULT_FULL);
	}
