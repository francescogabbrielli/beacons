...
public interface TransferListener<T extends BTData> extends EventListener {
	
	public void onBegin();
	
	public void onProgress(TransferResult<T> result);
	
	public void onEnd(TransferResult<T> lastResult); 
